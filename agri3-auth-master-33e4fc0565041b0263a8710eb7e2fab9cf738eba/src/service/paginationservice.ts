...
export class PaginationService {
   ...
   */
  public static async generateQueryWithMobilePagination(originalQuery: string, orderField: string, orderType: string, hasBottomIndex: boolean, hasSize: boolean, bottomIndex: number, size: number): Promise<QueryResult> {
   ...
   * @param size size
   */
  public static async generateQueryWithWebPagination(originalQuery: string, orderField: string, orderType: string, hasPage: boolean, hasSize: boolean, page: number, size: number): Promise<QueryResult> {
